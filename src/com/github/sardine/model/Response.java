...
public class Response {
	 ...
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the href property.
	 * <p/>
	 * <p/>
	 ...
	 * <p/>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the propstat property.
	 * <p/>
	 * <p/>
	 * For example, to add a new item, do as follows:
	 *
	...
	public List<Propstat> getPropstat() {
		if (this.propstat == null) {
			this.propstat = new ArrayList<Propstat>();
		}
