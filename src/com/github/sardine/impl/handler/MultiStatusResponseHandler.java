...
/**
 * {@link org.apache.http.client.ResponseHandler} which returns the {@link Multistatus} response of a {@link com.github.sardine.impl.methods.HttpPropFind}
 * request.
 *
 * @author mirko
 */
public class MultiStatusResponseHandler extends ValidatingResponseHandler<Multistatus> {
	...
	@Override
	public Multistatus handleResponse(final HttpResponse response) throws IOException {
