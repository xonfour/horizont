...
public class HttpPropFind extends HttpEntityEnclosingRequestBase {
	...
	/**
	 * Sets the <code>Depth</code> request header to <code>1</code>, meaning the request applies to the resource and its children.
	 *
	...
	/**
	 * A client may submit a Depth header with a value of "0", "1", or "infinity" with a {@link com.github.sardine.model.Propfind} on a collection resource with
