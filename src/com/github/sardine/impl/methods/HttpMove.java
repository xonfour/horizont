...
public class HttpMove extends HttpRequestBase {
	...
	public HttpMove(final String sourceUrl, final String destinationUrl, final boolean overwrite) {
		this(URI.create(sourceUrl), URI.create(destinationUrl), overwrite);
	}

	public HttpMove(final URI sourceUrl, final URI destinationUrl, final boolean overwrite) {
